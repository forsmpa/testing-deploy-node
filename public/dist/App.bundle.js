...
function autocomplete(input, latInput, lngInput) {
	...
	if (!input) return; // ship this fn from running if there is not input on the page
...
// navigatior.geolocation.getCurrentPostion
